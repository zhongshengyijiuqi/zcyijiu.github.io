...
``` html
   <div @click="taskLeaderBoxRadio">组织架构单选加部门</div>

      <frameworkDepartmentRadio
      :optionsShow="optionsBoxRadioShow" 
      :frameworkDepartment="frameworkBoxRadioData"
      @frameworkDepartmentRadioFun="frameworkCheckboxRadioFun" 
      @frameworkDepartmentReturnFun="frameworkreturnBoxRadioFun"
      ></frameworkDepartmentRadio>
```
``` js
    export default {
        data(){
            return{
            //人员+部门单选
                optionsBoxRadioShow:false,
                frameworkBoxRadioData:{//组织架构
                    deptList:[],
                    departmentList:[],
                    choiceData:[
        ...
        methods:{
            taskLeaderBoxRadio(){
                this.optionsBoxRadioShow = true
                this.frameworkBoxRadioData.choiceData = this.multipleSonRadio
                this.frameworkBoxRadioData.multipleChoice = this.multipleChoiceRadioList
            },
                //单选 + 部门
            frameworkCheckboxRadioFun(item){
                console.log(item)
                this.multipleSonRadio = item.multipleSon
                this.multipleChoiceRadioList = item.multipleChoice
                this.optionsBoxRadioShow = false
            },
            frameworkreturnBoxRadioFun(){
                this.optionsBoxRadioShow = false
            },
           ...
           async postMemberInfoByDeptFun(){
                try {
                    ...
                    this.frameworkBoxRadioData.deptList = JSON.parse(JSON.stringify(deptConcatlist)) 
                    this.frameworkBoxRadioData.departmentList = JSON.parse(JSON.stringify(this.deptConcat))
                } catch (error) {
...
### frameworkDepartmentRadioFun 事件
